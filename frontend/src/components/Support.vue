<template>
  <div style="display: contents;">
      ...
      <div class="flex flex-grow items-center justify-center relative z-10">
        ...
        <div class="flex flex-col w-full max-w-5xl mx-auto p-6 md:p-8 bg-[#111111]/80 rounded-xl shadow-lg">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <!-- Card 1: My Account -->
            <div class="bg-[#313131]/80 rounded-lg shadow p-6 transition-colors duration-300 cursor-pointer hover:bg-[#313131]/90">
            ...
            <div class="bg-[#313131]/80 rounded-lg shadow p-6 transition-colors duration-300 cursor-pointer hover:bg-[#313131]/90">
              <div class="mb-4 text-[#8FC773] flex justify-center">
                ...
                <svg
                  ...
                  stroke-width="2"
                >
                  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15a4.5 4.5 0 004.5 4.5h9.75a4.5 4.5 0 004.5-4.5v-6a4.5 4.5 0 00-4.5-4.5H6.75a4.5 4.5 0 00-4.5 4.5v6z" />
                </svg>
              </div>
              <h2 class="text-xl font-medium text-[#8FC773] mb-2 text-center">
                WhatsApp &amp; SMS
            ...
            <div class="bg-[#313131]/80 rounded-lg shadow p-6 transition-colors duration-300 cursor-pointer hover:bg-[#313131]/90">
              <div class="mb-4 text-[#8FC773] flex justify-center">
                ...
                <svg
                  ...
                  stroke-width="2"
                >
                  <path stroke-linecap="round" stroke-linejoin="round" d="M20 13V7a1 1 0 00-1-1H5a1 1 0 00-1 1v6m16 0l-3 3m3-3l-3-3" />
                </svg>
              </div>
              <h2 class="text-xl font-medium text-[#8FC773] mb-2 text-center">
            ...
            <div class="bg-[#313131]/80 rounded-lg shadow p-6 transition-colors duration-300 cursor-pointer hover:bg-[#313131]/90">
              <div class="mb-4 text-[#8FC773] flex justify-center">
                ...
                <svg
                  ...
                  stroke-width="2"
                >
                  <path stroke-linecap="round" stroke-linejoin="round" d="M17.5 6.5a2.121 2.121 0 00-3 0l-7 7a2.121 2.121 0 000 3l2 2a2.121 2.121 0 003 0l7-7a2.121 2.121 0 000-3l-2-2z" />
                </svg>
              </div>
              <h2 class="text-xl font-medium text-[#8FC773] mb-2 text-center">
                Contacts
    ...
    <div>
      ...
      <div
        v-if="showChat"
        class="fixed bottom-16 right-4 z-50 bg-[#111111]/80 rounded-xl shadow-lg w-80 h-96 flex flex-col"
      >
  ...
  methods: {
    ...
    sendMessage() {
      if (this.message.trim() !== "") {
        // Future integration: Send this.message to your AI chatbot service.
